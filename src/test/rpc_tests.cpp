...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    // S256: re-encoded from real-Bitcoin-mainnet base58 (address/WIF, same
    // technique as bip32_tests.cpp etc.) to S256's own mainnet prefixes
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"8XE1SZDdbXmBWJABXRsip6L9P8pojr5Rq3\":11}");
    std::string notsigned = r.get_str();
    std::string privkey1 = "\"VKQFzmWpmCoimgV9MnBk7PMnpgMykH5JNB44wZ441rZhF1f4N4vL\"";
    std::string privkey2 = "\"VJEMgF3aM99cTHUUzkTRLqg9qtPb1g9KXnQXze5NGxW8U7vPkTe9\"";
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> sha256coin-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> sha256coin-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> sha256coin-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> sha256coin-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> sha256coin-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> sha256coin-cli -named test name='[\"bar\",false,1]'\n");
