...
const char * const BITCOIN_CONF_FILENAME = "sha256coin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Local\SHA256Coin
    // macOS: ~/Library/Application Support/SHA256Coin
    // Unix-like: ~/.sha256coin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_LOCAL_APPDATA) / "SHA256Coin";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    // macOS
    return pathRet / "Library/Application Support/SHA256Coin";
#else
    // Unix-like
    return pathRet / ".sha256coin";
#endif
#endif
}
