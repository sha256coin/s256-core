...
const std::string EXAMPLE_ADDRESS[2] = {"s21q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "s21q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
{
    return "> sha256coin-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> sha256coin-cli -named " + methodname;
