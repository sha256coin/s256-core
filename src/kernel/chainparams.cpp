...
public:
    CMainParams() {
        ...
        // S256: this was missing entirely from CMainParams (present on
        // testnet/testnet4/signet below, generated together on 2026-02-25
        // during the v31.1 merge -- mainnet's own entry was dropped
        // somewhere in that merge's manual conflict resolution, since this
        // class needed far more hand-reconciliation than the other chains).
        // The gap is a hard crash, not a soft miss: any node syncing
        // headers from scratch (i.e. every real user) hits
        // TryLowWorkHeadersSync() on its very first low-work headers batch,
        // which asserts commitment_period > 0 -- reproduced live 2026-09-02
        // syncing this build against real mainnet peers. Regenerated with
        // contrib/devtools/headerssync-params.py using S256's own
        // parameters: BLOCK_INTERVAL=1200s (20-minute blocks, not
        // Bitcoin's 600s) and MINCHAINWORK_HEADERS=11277 (the height behind
        // nMinimumChainWork above, not Bitcoin's own chain height).
        // Generated by headerssync-params.py on 2026-09-02.
        m_headers_sync_params = HeadersSyncParams{
            .commitment_period = 562,
            .redownload_buffer_size = 17332, // 17332/562 = ~30.8 commitments
        };
    }
};
