...
{
    switch (unit) {
    case Unit::BTC: return QString("S256");
    case Unit::mBTC: return QString("mS256");
    case Unit::uBTC: return QString::fromUtf8("µS256 (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("SHA256Coins");
    case Unit::mBTC: return QString("Milli-S256 (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-S256 (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
