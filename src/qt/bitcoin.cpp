...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if (success) {
        ...
        // sha256coin: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6-7. Parse sha256coin.conf, determine network, switch to network specific
    ...
    // sha256coin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
