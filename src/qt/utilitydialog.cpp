    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The sha256coin-qt application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core functionalities of sha256coind with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
                         ...
                         "Usage: sha256coin-qt [options] [URI]\n\n";
