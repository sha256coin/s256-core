...
bool Intro::showIfNeeded(bool& did_show_intro, int64_t& prune_MiB)
{
     ...
     * override -datadir in the sha256coin.conf file in the default data directory
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the SHA256Coin block chain.").arg(CLIENT_NAME) + " " +
